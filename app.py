...
# buttons part 2
 ...
 Button(root, text="%", command=lambda: get_operation("%")).grid(row=5, column=0, sticky=W+E)
 ...
 Button(root, text="⟶" , command=lambda: undo()).grid(row=2, column=4, sticky=W+E, columnspan = 2)
  Button(root, text="exp", command=lambda: get_operation("**")).grid(row=3, column=4, sticky=W+E)
   Button(root, text="^2", command=lambda: get_operation("**2")).grid(row=4, column=5, sticky=W+E)
